...
var DetectNetwork = function () {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.prev = 0;
                  _context.next = 3;
                  return netinfo_1.isConnectionExpensive();
          ...
          return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.next = 2;
                  return netinfo_1.getConnectionInfo();
  ...
  (0, _createClass3.default)(DetectNetwork, [{
    ...
    value: function _addListeners() {
      ...
      netinfo_1.addEventListener('connectionChange', function (connectionInfo) {
...
var isLegacy = typeof netinfo_1.getConnectionInfo === 'undefined';
