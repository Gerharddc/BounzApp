        ...
        return (
            ...
            >
                {({ data, error, fetchMore, refetch, loading }) => {
                    ...
                    let searched = data.listOwnerCourts.items;
                    if (text !== '' && searched) {
                    ...
                    const nextToken = data.listOwnerCourts.nextToken;
                    return (
                        <FlatList
                            data={searched}
                            renderItem={({ item }) => (
                                ...
                                <View style={{ flex: 1 }}>
                                    <View style={{ flex: 1, justifyContent: 'center' }}>
                                        ...
                                        <Text style={{ textAlign: 'center' }}>
                                            {'Maybe this user should create some courts 🤷'}
                                        </Text>
                                    </View>
                                    <Animatable.Image
                                        resizeMode="contain"
